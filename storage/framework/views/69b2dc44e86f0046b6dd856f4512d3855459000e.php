    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <ul class="sub">
                        <li><a href="<?php echo e(route('addpost')); ?>">Thêm tin tức</a></li>
                        <li><a href="<?php echo e(route('allpost')); ?>">Liệt kê tin tức</a></li>
                    </ul>
                </li>
...
<?php /**PATH C:\xampp\htdocs\shopbanhanglaravel\resources\views/admin_layout.blade.php ENDPATH**/ ?>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 0975.720.527</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> nguyenngocnam00770@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown">
                                    <a href="<?php echo e(route('tintuc')); ?>">Tin tức<i class="fa fa-angle-down"></i></a>
                                </li>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="item <?php echo e($i==1 ? 'active' : ''); ?>">
                                ...
                                <div class="col-sm-12">
                                    <img alt="<?php echo e($slide->slider_desc); ?>" src="public/uploads/slider/<?php echo e($slide->slider_image); ?>" height="100%" width="100%" class="img img-responsive img-slider">
...
<?php /**PATH C:\xampp\htdocs\shopbanhanglaravel\resources\views/layout.blade.php ENDPATH**/ ?>
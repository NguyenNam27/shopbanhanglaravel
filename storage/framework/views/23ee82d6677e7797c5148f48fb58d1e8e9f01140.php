							...
							<div class="product-information"><!--/product-information-->
								...
								<form action="<?php echo e(URL::to('/save-cart')); ?>" method="POST">
									<?php echo csrf_field(); ?>
                                            ...
                                            <input type="hidden" value="public/uploads/product/<?php echo e($value->product_image); ?>" class="cart_product_image_<?php echo e($value->product_id); ?>">
										...
										<div class="product-image-wrapper">
											 <div class="single-products">
		                                        <div class="productinfo text-center product-related">
                                                    <a href="<?php echo e(URL::to('/chi-tiet/'.$lienquan->product_slug)); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopbanhanglaravel\resources\views/pages/sanpham/show_details.blade.php ENDPATH**/ ?>
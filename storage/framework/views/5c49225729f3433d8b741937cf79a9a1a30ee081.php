        ...
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
              ...
              <?php
                                    ...
                                    ?>
                <a href="<?php echo e(URL::to('/unactive-post/'.$post->id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                <?php
                                    }else{
                                    ?>
                 <a href="<?php echo e(URL::to('/active-post/'.$post->id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
                                    }
                                    ?>
            </span></td>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopbanhanglaravel\resources\views/admin/all_post.blade.php ENDPATH**/ ?>
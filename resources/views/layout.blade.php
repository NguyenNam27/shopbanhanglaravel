                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown">
                                    <a href="{{route('tintuc')}}">Tin tức<i class="fa fa-angle-down"></i></a>
                                </li>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        @foreach($slider as $key => $slide)
                            ...
                            <div class="item {{$i==1 ? 'active' : '' }}">
                                ...
                                <div class="col-sm-12">
                                    <img alt="{{$slide->slider_desc}}" src="public/uploads/slider/{{$slide->slider_image}}" height="100%" width="100%" class="img img-responsive img-slider">
